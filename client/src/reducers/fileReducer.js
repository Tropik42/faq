...
const SET_POPUP_NOTE_DISPLAY = "SET_POPUP_NOTE_DISPLAY"
...
export default function fileReducer(state = defaultState, action) {
    switch (action.type) {
        ...
        case SET_POPUP_NOTE_DISPLAY: return {...state, popupNoteDisplay: action.payload}
        case PUSH_TO_STACK: return {...state, dirStack: [...state.dirStack, action.payload]}
        case DELETE_FILE: return {...state, files: [...state.files.filter(file => file.file_id !== action.payload)]}
...
export const setPopupNoteDisplay = (display) => ({type: SET_POPUP_NOTE_DISPLAY, payload: display})
